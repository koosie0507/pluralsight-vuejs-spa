  ...
  data () {
    return {
      ...
      postsFrontEnd: [
        ...
        { id: 2, title: 'A Comprehensive Guide To HTTP/2 Server Push', content: 'No longer is HTTP/2 a feature we pine for. It has arrived, and with it comes api push!', link: 'https://www.smashingmagazine.com/2017/04/guide-http2-api-push/' },
